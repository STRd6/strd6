class GameController < ApplicationController
    ...
    if area
      if old_area = active_character.area
        render_to_area old_area do |page|
          page.call :addEvent, "#{h active_character.name} has left the area."
      ...
      render_to_area area do |page|
        page.call :addEvent, "#{h active_character.name} has entered the area."
  ...
  def ability
    begin
      ...
      if new_item
        render_to_area active_character.area do |page|
          page.call :addEvent, "#{h active_character.name} chopped some wood."
